...
export function HeroSection() {
  return(
    <div className="bg-orange-200 lg:bg-orange-200/60 h-full p-10 flex flex-col items-center">
      <h1 class="text-center text-2xl lg:text-3xl uppercase mb-10">Dovolená s námi</h1>
